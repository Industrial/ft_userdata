...
class newstrategy4(IStrategy):
    ...
    sell_deadfish_profit = DecimalParameter(
        -0.15, -0.05, default=-0.08, space="sell", optimize=is_optimize_deadfish
    )
    ...
    sell_trail_profit_min_2 = DecimalParameter(
        0.04, 0.1, default=0.04, space="sell", decimals=3, optimize=False, load=True
    )
    sell_trail_profit_max_2 = DecimalParameter(
        0.08, 0.25, default=0.11, space="sell", decimals=2, optimize=False, load=True
    )
