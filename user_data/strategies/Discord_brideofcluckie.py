...
class brideofcluckie(IStrategy):
    ...
    sell_params = {"sell-bbmiddle-close": 0.74102}

    # ROI table:
    minimal_roi = {"0": 0.01, "45": 0.0025}
        ...
        dataframe.loc[
            ...
            & (
                (  # strategy BinHV45
                    ...
                    & (
                        dataframe["bbdelta"].gt(
                            dataframe["ha_close"] * params["bbdelta-close"]
                        )
                    )
                    & (
                    ...
                    & (
                        dataframe["tail"].lt(
                            dataframe["bbdelta"] * params["bbdelta-tail"]
                        )
                    )
                ...
                | (  # strategy ClucMay72018
                    ...
                    & (
                        dataframe["ha_close"]
                        < (params["close-bblower"] * dataframe["bb_lowerband"])
                    )
                    & (
                        dataframe["volume"]
